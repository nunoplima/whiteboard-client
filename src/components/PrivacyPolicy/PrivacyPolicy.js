...
const PrivacyPolicy = () => {
    ...
    return (
        ...
        <>
            <div className={"leaderboardTitle"}>Privacy Policy</div>

            <div id="privacyPolicy" className="tableContainer">
                <div className="privacyPolicyContainer">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to whiteboard.</p>
                            </li>
                        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                        <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                        <li><strong>Website</strong> refers to whiteboard, accessible from https://whiteboard.herokuapp.com</li>        
                    ...
                    <p>You can log in to our App using Facebook Connect. This service will authenticate your identity and will ask you to share your first and last name in order for you to be able to log your wod results and be placed in the leaderboard.</p>
